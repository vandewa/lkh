...
<head>
	...
	<link href="{{ asset('dashtrans/vertical/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css')}}" rel="stylesheet" />
	<link href="{{ asset('dashtrans/vertical/assets/plugins/metismenu/css/metisMenu.min.css')}}" rel="stylesheet" />
	<link href="{{ asset('dashtrans/vertical/assets/plugins/datatable/css/dataTables.bootstrap5.min.css')}}" rel="stylesheet" />
	...
	<link href="{{ asset('dashtrans/vertical/assets/plugins/select2/css/select2-bootstrap4.css')}}" rel="stylesheet" />
